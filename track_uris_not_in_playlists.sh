...
usage_description="
Finds track URIs in given spotify playlist that are NOT in the other given spotify/ URI export files
"

# used by usage() in lib/utils.sh
# shellcheck disable=SC2034
usage_args="<playlist> <not_in_this_playlist> [<not_in_this_playlist> ...]"
...
filter_URIs(){
    ...
    grep -Fvxh -f "$other_playlist_file" "$playlist_file" || :
}
